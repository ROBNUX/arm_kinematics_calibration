...
int XyzGantryCalib::CartToJnt(const Pose &pos, Eigen::VectorXd *q) {
...
void XyzGantryCalib::UpdateConfigTurn(const Eigen::VectorXd &theta,
...
bool XyzGantryCalib::PickSubJacobian(const Eigen::MatrixXd &Jp_t,
...
double XyzGantryCalib::PickCartErr(const Eigen::Vector3d &errT,
...
void XyzGantryCalib::UpdateDH(const Eigen::VectorXd &orig_dh,
...
void XyzGantryCalib::UpdateDH(const Eigen::VectorXd &jnt,
